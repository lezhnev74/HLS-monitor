...
class PlaylistTest extends \PHPUnit\Framework\TestCase
{
    ...
    function test_playlist_parses_m3u8_with_no_streams()
    {
        ...
        $playlist = new \Lezhnev74\HLSMonitor\Data\Playlist\Playlist(file_get_contents($path), $url);
    ...
    {
        $this->expectException(\Lezhnev74\HLSMonitor\Data\Playlist\InvalidPlaylistFormat::class);
